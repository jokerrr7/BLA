...
------------
if text == 'جوكر' or text == 'محمد' or text == 'الجوكر' or text == 'مبرمج السورس¹' then
local Text =[[
...
if text == 'جاك' or text == 'خالد' or text == 'مبرمج السورس²' or text == '"' then
local Text =[[
...
if text == '/start' then   
if not BLACKx1:get(BLACK..'Start:Time'..msg.sender_user_id_) then
local inline = {{{text="المطور",url="t.me/"..(SudoFaeder or "BLACK_TEAM_4")}}}
local Sudo_Welcome = '⚘يمكنك ايضا استخدام مبرامجين السورس \n⚘اليك ازرار يا حكاك اسفل الرساله\n                ❀❀❀❀❀❀❀❀\n                              [𝐁𝐋𝐀𝐂𝐊 - 𝐂𝐇](https://t.me/BLACK_TEAM_4)'
local key = {
{'اضغط هنا'},
{'مبرمج السورس¹'},
{'مبرمج السورس²'},
...
local start = BLACKx:get(BLACK.."Start:Bot")
if start then 
Start_Source = start
else
...
BLACKx:setex(BLACK..'Start:Time'..msg.sender_user_id_,300,true)
return false
end end
--------
...
彡 .[SOURCE BLACK ◍](t.me/BLACK_TEAM_4)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == '/start' then   
if not BLACKx1:get(BLACK..'Start:Time'..msg.sender_user_id_) then
local inline = {{{text="المطور",url="t.me/"..(SudoFaeder or "Source_BLACK")}}}
local Sudo_Welcome = '⚘يمكنك ايضا استخدام مبرامجين السورس \n⚘اليك ازرار يا حكاك اسفل الرساله\n                ❀❀❀❀❀❀❀❀\n                              [𝐁𝐋𝐀𝐂𝐊 - 𝐂𝐇](https://t.me/Source_BLACK)'
local key = {
{'اضغط هنا'},
{'مبرمج السورس¹'},
{'مبرمج السورس²'},
