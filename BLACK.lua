...
if text == "الرابط" then
if not BLA:get(BLACK.."Abs:Lock:GpLinks"..msg.chat_id_) then 
if BLA:get(BLACK.."Abs:Groups:Links"..msg.chat_id_) then
BLA(msg.chat_id_, msg.id_, 1, "⌁︙𝒈𝒓𝒐𝒖𝒑 𝒍𝒊𝒏𝒌 ↬ ⤈ \n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n"..BLA:get(BLACK.."Abs:Groups:Links"..msg.chat_id_), 1, "html")
else 
